...
export default class Keyboard {
    ...
    pressKey(event) {
        ...
        if (this.scores.isFocused) {
            ...
            // Safely resolve the shortcut map for the current display state.
            // If there is no map or no handler for this shortcut, just ignore it.
            const map = this.shortcuts ? this.shortcuts[this.display.current] : null;
            if (map && typeof map[shortcut] === "function") {
                map[shortcut]();
            }
        }
    }
